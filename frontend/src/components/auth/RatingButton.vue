<template>
  ...
  >
    <div
      class="inline-flex cursor-pointer text-3xl text-amber-300 transition-all duration-300"
      :class="[
        'inline-flex cursor-pointer text-3xl text-amber-300 transition-all duration-300',
        { 'text-grey pointer-events-none': !isAuthenticated },
      ]"
    ...
    <span class="text-dark-grey text-xl">{{ displayRating.toFixed(1) }}</span>
  </section>
  <article v-else class="text-base font-bold text-red-500">
